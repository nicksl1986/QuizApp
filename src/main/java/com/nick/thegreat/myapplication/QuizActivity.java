...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewDifficultyLevel = findViewById(R.id.text_view_difficulty_level);
        ...
        textViewDifficultyLevel.setText("Difficulty : " + difficulty);
    ...
    public void onBackPressed() {
        ...
        {
            Toast.makeText(QuizActivity.this, "Press back button again to finish",
